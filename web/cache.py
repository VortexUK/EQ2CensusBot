...
class TTLCache:
    def __init__(self, ttl: int = 300, max_age: int | None = None):
        """
...
character_cache: TTLCache = TTLCache(ttl=300, max_age=3600)
guild_cache:     TTLCache = TTLCache(ttl=300, max_age=3600)
claim_cache:     TTLCache = TTLCache(ttl=300, max_age=3600)
